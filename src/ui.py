...
def initUI(self):
    ...
    self.filename_info = QLabel(window)
    self.filename_info.setObjectName("fileInfo")
    self.filename_info.setGeometry(10, 345, 200, 50)

    self.previous_btn = QPushButton(self.image_label)
    self.previous_btn.setGeometry(QRect(5, 158, 32, 32))
    self.previous_btn.setObjectName('navigate')
    self.previous_btn.setIcon(QIcon('assets/back.png'))
    self.previous_btn.clicked.connect(self.previous_image)

    self.next_btn = QPushButton(self.image_label)
    self.next_btn.setGeometry(QRect(563, 158, 32, 32))
    self.next_btn.setObjectName('navigate')
    ...
    self.set_as_wallpaper_btn.setGeometry(QRect(495, 360, 95, 30))
    ...
    self.add_to_favs_btn.setGeometry(QRect(365, 360, 111, 30))
    ...
    self.change_every_label.setGeometry(QRect(330, 416, 94, 38))
    ...
    self.directory_label.setGeometry(QRect(330, 515, 70, 15))
    ...
    self.change_every_label.setText("Frequency :")
