...
def initUI(self):
    ...
    self.set_as_wallpaper_btn = QPushButton(self.window)
    ...
    self.add_to_favs_btn = QPushButton(self.window)
    ...
    self.next_image_btn = QPushButton(self.window)
    ...
    self.addsub = QLineEdit(self.window)
    ...
    self.addsub.setStyleSheet('QLineEdit {font-size: 12px; padding-left: 5px;}')
    # self.addsub.setFocus()

    self.addsub_btn = QPushButton(self.window)
    ...
    self.change_every_combobox = QComboBox(self.window)
    ...
    self.h1_line = QFrame(self.window)
    ...
    self.h2_line = QFrame(self.window)
